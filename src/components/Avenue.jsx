...
const images = [
  "/img/project/project-3-1.png",
  "/img/project/project-3-2.png",
  "/img/project/project-3-3.png",
  "/img/project/project-3-4.png",
  "/img/project/project-3-5.png",
  "/img/project/project-3-6.png",
  "/img/project/project-3-7.png",
  "/img/project/project-3-8.png"
];
